...
| `GET` | `/admin/cynexgp-cloud` | 👑 | CynexGP Cloud settings page |
| `POST` | `/admin/cynexgp-cloud` | 👑 | Update CynexGP Cloud settings |
...
2. **Basic Auth** - `Authorization: Basic <base64(CynexGP:<key>)>`
3. **HMAC-SHA256** - `X-CynexGP-Timestamp`, `X-CynexGP-Signature`, `X-CynexGP-Nonce` headers
...
Panel                                    Daemon
  ...
  │     X-CynexGP-Timestamp: <ts>          │
  │     X-CynexGP-Signature: <hex>         │
  │     X-CynexGP-Nonce: <nonce>           │
  │──────────────────────────────────────▶  │
...
Authorization: Basic Q3luZXhHUDp5b3VyLXNlY3JldC1rZXk=
X-CynexGP-Timestamp: 1718476800
X-CynexGP-Signature: a1b2c3d4e5f6...
X-CynexGP-Nonce: 8f14e45fceea167a5a36dedd4bea2543
...
| Header | Description |
|--------|-------------|
| `X-CynexGP-Timestamp` | Unix epoch seconds |
| `X-CynexGP-Signature` | HMAC-SHA256 hex digest |
| `X-CynexGP-Nonce` | Random nonce (16 bytes hex) |
