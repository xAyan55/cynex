(function () {
  ...
  // Call window.cynexgpAnimate(el) on any element to run the standard
  // entrance animation: fade in + slight upward slide.
  window.cynexgpAnimate = function (el, options) {
