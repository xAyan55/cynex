...
export const loadModules = async (
  ...
  const ascii = [
    ...
    '| $$    $$| $$  | $$| $$  | $| $$_____/ >$$  $$ | $$  \\ $$| $$         ',
    '|  $$$$$$/|  $$$$$$$| $$  | $|  $$$$$$$/$$/\\  $$|  $$$$$$/| $$         ',
    ' \\______/  \\____  $$|__/  |__/ \\______/|__/  \\__/ \\______/ |__/         ',
    '           /$$  | $$                                                ',
    '          |  $$$$$$/                                                ',
    '           \\______/                                                 ',
    '                                                                    ',
  ...
  for (const result of results) {
    ...
    if (mod.info.version !== cynexgpVersion) {
      logger.warn(`Skipping incompatible module: ${mod.info.name} (requires v${mod.info.version}, found v${cynexgpVersion})`);
      skipped++;
      continue;
    }
